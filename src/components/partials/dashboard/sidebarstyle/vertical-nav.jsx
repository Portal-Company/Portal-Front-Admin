      ...
      <Accordion as="ul" className="navbar-nav iq-main-menu" id="sidebar-menu">
        ...
        >
          ...
          >
            ...
            <span className="item-name">Cargos</span>
            <i className="right-icon">
              <svg
                className="icon-18"
                xmlns="http://www.w3.org/2000/svg"
          ...
          <Accordion.Collapse eventKey="area-cargo">
            <ul className="sub-nav">
              <Nav.Item as="li">
                <Link
                  className={`${
                    location.pathname === "/cargo/cargo-add" ? "active" : ""
                  } nav-link`}
                  to="/cargo/cargo-add"
                >
                  <i className="icon">
                  ...
                  <span className="item-name">Adicionar Cargo</span>
                </Link>
              </Nav.Item>
              <Nav.Item as="li">
                <Link
                  className={`${
                    location.pathname === "/cargo/cargo-list" ? "active" : ""
                  } nav-link`}
                  to="/cargo/cargo-list"
                >
                  <i className="icon">
                  ...
                  <span className="item-name">Listar Cargo</span>
                </Link>
              </Nav.Item>
            </ul>
          </Accordion.Collapse>
        ...
        >
          ...
          >
            ...
            <span className="item-name">Area de Disciplina</span>
            <i className="right-icon">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="icon-18"
          ...
          <Accordion.Collapse eventKey="area-disciplina">
            <ul className="sub-nav">
              <Nav.Item as="li">
                <Link
                  className={`${
                    location.pathname === "/disciplina/disciplina-add"
                      ? "active"
                      : ""
                  } nav-link`}
                  to="/disciplina/disciplina-add"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
                  ...
                  <span className="item-name">Adicionar Disciplina</span>
                </Link>
              </Nav.Item>
              <Nav.Item as="li">
                <Link
                  className={`${
                    location.pathname === "/disciplina/disciplina-list"
                      ? "active"
                      : ""
                  } nav-link`}
                  to="/disciplina/disciplina-list"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
                  ...
                  <span className="item-name">Listar Disciplina</span>
                </Link>
              </Nav.Item>
            </ul>
          </Accordion.Collapse>
            ...
            <ul className="sub-nav">
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  <span className="item-name">Admitidos</span>
                </Link>
              </Nav.Item>
              <Nav.Item as="li">
                <Link
                ...
                >
                  ...
                  <span className="item-name">Não Admitidos</span>
                </Link>
              </Nav.Item>
            </ul>
          </Accordion.Collapse>
        ...
        >
          ...
          <Accordion.Collapse eventKey="area-disciplina1">
            <ul className="sub-nav">
              <Nav.Item as="li">
                <Link
                  className={`${
