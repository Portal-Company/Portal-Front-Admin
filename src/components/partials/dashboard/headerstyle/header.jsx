...
//Img
import flag1 from '/src/assets/images/Flag/flag001.png'
...
const Header = memo((props) => {
    ...
    return (
        <Fragment>
            <Navbar expand="lg" variant="light" className="nav navbar navbar-expand-lg navbar-light iq-navbar">
                <Container fluid className="navbar-inner">
                    ...
                    <Navbar.Collapse id="navbarSupportedContent" className='collapse'>
                        <Nav as="ul" className="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                                    ...
                                    <div className="m-0 border-0 shadow-none card">
                                        <div className="p-0 ">
                                            <ul className="p-0 list-group list-group-flush">
                                                <Nav.Item as="li" className="iq-sub-card list-group-item"><Link className="p-0" to="#"><img src={flag3} alt="img-flaf" className="img-fluid me-2" style={{ width: "15px", height: "15px", minWidth: "15px", }} loading="lazy" />Italian</Link></Nav.Item>
                                                <Nav.Item as="li" className="iq-sub-card list-group-item"><Link className="p-0" to="#"><img src={flag4} alt="img-flaf" className="img-fluid me-2" style={{ width: "15px", height: "15px", minWidth: "15px", }} loading="lazy" />French</Link></Nav.Item>
                                                <Nav.Item as="li" className="iq-sub-card list-group-item"><Link className="p-0" to="#"><img src={flag2} alt="img-flaf" className="img-fluid me-2" style={{ width: "15px", height: "15px", minWidth: "15px", }} loading="lazy" />German</Link></Nav.Item>
                                                <Nav.Item as="li" className="iq-sub-card list-group-item"><Link className="p-0" to="#"><img src={flag5} alt="img-flaf" className="img-fluid me-2" style={{ width: "15px", height: "15px", minWidth: "15px", }} loading="lazy" />Spanish</Link></Nav.Item>
                                                <Nav.Item as="li" className="iq-sub-card list-group-item"><Link className="p-0" to="#"><img src={flag6} alt="img-flaf" className="img-fluid me-2" style={{ width: "15px", height: "15px", minWidth: "15px", }} loading="lazy" />Japanese</Link></Nav.Item>
                                            </ul>
                                        </div>
                                    </div>
                                </Dropdown.Menu>
                            ...
                            <Dropdown as="li" className="nav-item">
                                ...
                                <Dropdown.Menu className="dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <Dropdown.Item href="https://templates.iqonic.design/qompac-ui/react/build/dashboard/app/user-profile">Profile</Dropdown.Item>
                                    <Dropdown.Item href="https://templates.iqonic.design/qompac-ui/react/build/dashboard/app/user-privacy-setting">Privacy Setting</Dropdown.Item>
                                    <Dropdown.Divider />
                                    <Dropdown.Item href="https://templates.iqonic.design/qompac-ui/react/build/auth/sign-in">Logout</Dropdown.Item>
                                </Dropdown.Menu>
                            </Dropdown>
                        </Nav>
                    </Navbar.Collapse>
