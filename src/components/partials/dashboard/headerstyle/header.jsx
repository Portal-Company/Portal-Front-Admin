      ...
      >
        <Container fluid className="navbar-inner">
          <Link to="/" className="navbar-brand">
            <Logo color={true} />
            <h4 className="logo-title">PORTAL DAS ESCOLAS</h4>
          </Link>
          <div
          ...
          <Navbar.Collapse id="navbarSupportedContent" className="collapse">
            <Nav
              as="ul"
              className="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0"
            >
              ...
              <Dropdown as="li" className="nav-item">
                ...
                >
                  <Dropdown.Item href="https://templates.iqonic.design/qompac-ui/react/build/dashboard/app/user-profile">
                    Profile
                  </Dropdown.Item>
                  <Dropdown.Item href="https://templates.iqonic.design/qompac-ui/react/build/dashboard/app/user-privacy-setting">
                    Privacy Setting
                  </Dropdown.Item>
                  <Dropdown.Divider />
                  <Dropdown.Item href="https://templates.iqonic.design/qompac-ui/react/build/auth/sign-in">
                    Logout
                  </Dropdown.Item>
                </Dropdown.Menu>
              </Dropdown>
