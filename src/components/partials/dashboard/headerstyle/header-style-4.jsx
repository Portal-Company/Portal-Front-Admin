...
//React-bootstrap
import { Navbar, Container, Nav, Dropdown, Card, Image } from "react-bootstrap";
...
import Flag1 from "/src/assets/images/Flag/flag-03.png";
import Flag2 from "/src/assets/images/Flag/flag-04.png";
  ...
  return (
    <Fragment>
      <Navbar
        ...
        expand="lg"
        variant="dark"
        className="nav  navbar-expand-xl fixed-top navbar-dark bg-dark iq-navbar iq-dual-compact"
        ...
        <Container fluid className="navbar-inner">
          ...
          <Navbar.Collapse className="offcanvas-collapse">
            ...
            <ul className="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
              <Dropdown className="nav-item me-0 me-xl-0 ">
                      ...
                      <div className="header-title">
                        <div className="iq-search-bar device-search  position-relative">
                          <form action="#" className="searchbox">
                            ...
                            />
                            <Link className="d-lg-none d-flex" to="# ">
                      ...
                      <div className="iq-sub-card">
                        <div className="d-flex align-items-center">
                          ...
                          <div className="ms-3 flex-grow-1">
                            ...
                            <div className="d-flex justify-content-between align-items-center">
                              <p className="mb-0">Paul.45</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div className="iq-sub-card mb-0">
                        <div className="d-flex align-items-center">
                          <Image
                            className="p-1 avatar-40 rounded-pill bg-soft-primary"
                            src={img2}
              ...
              <Dropdown as="li" className="nav-item theme-scheme-dropdown">
                ...
                >
                  ...
                  >
                    ...
                    <h6 className="ms-3 mb-0">Light</h6>
                  </Dropdown.Item>
                  <Dropdown.Item
                    to="#"
                    className="dropdown-item d-flex align-items-center"
                  >
                    ...
                    <h6 className="ms-3 mb-0">Dark</h6>
                  </Dropdown.Item>
                  <Dropdown.Item
                    to="#"
                    className="dropdown-item d-flex align-items-center"
                  >
                    ...
                    <h6 className="ms-3 mb-0">Auto</h6>
                  </Dropdown.Item>
                </Dropdown.Menu>
              </Dropdown>
              <Dropdown
              ...
              <Dropdown as="li" className="nav-item iq-tour ps-3 ps-lg-0">
                ...
                >
                  ...
                  <div className="caption ms-3 d-none d-md-block ">
                    <h6 className="mb-0 caption-title text-white">
                      Austin Robertson
                    </h6>
      ...
      <div className="nav-scroller bg-body shadow-sm">
        <div className="container-fluid">
          <nav className="nav nav-underline" aria-label="Secondary navigation">
            <ul className="iq-nav-menu list-unstyled flex-row py-1">
              ...
              {/* <li className="nav-item"><Link className="nav-link" to="/ecommerce-dashboard">E-Commerce</Link></li> */}
              <li className="nav-item">
