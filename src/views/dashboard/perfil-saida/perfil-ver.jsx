...
// img
import avatars11 from "/src/assets/images/avatars/maka.jpg";
                  ...
                  <Card.Body className="p-0">
                    ...
                    <div className="comment-area p-3">
                      <div className="d-flex flex-wrap justify-content-between align-items-center">
                        ...
                        {/* <div className="share-block d-flex align-items-center feather-icon">
                                       <Link to="#" data-bs-toggle="offcanvas" id="#share-btn" aria-controls="share-btn">
                                          <span className="ms-1">
                                             <svg width="18" viewBox="0 0 24 24" className="me-1">
                  ...
                  <Card.Body>
                    <div className="text-center">
                      ...
                      <div className="mt-3">
                        ...
                        <p className="d-inline-block pl-3"> - Ensino Médio</p>
                        <p className="mb-0">
