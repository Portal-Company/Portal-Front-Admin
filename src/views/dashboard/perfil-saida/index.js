...
<div className="form-card text-start">
  <div className="row">
    <div className="col-7">
      <h3 className="mb-4">Informações sobre o Historial</h3>
    </div>
  </div>
  <div className="row">
    <div className="col-md-6">
...
<div className="form-card text-start">
  <div className="row">
    <div className="col-7">
      <h3 className="mb-4">Carregamento de imagem:</h3>
    </div>
  </div>
  <div className="form-group">
...
<div className="form-card">
  <Row>
    <div className="col-7">
      <h3 className="mb-4 text-left">Concluído:</h3>
    </div>
  </Row>
  <br />
  <br />
  ...
  <div className="row justify-content-center">
    <div className="col-7 text-center">
      <h5 className="purple-text text-center">
        Informações Gravada com sucesso
      </h5>
    </div>
  </div>
</div>
