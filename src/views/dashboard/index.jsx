              ...
              <div>
                <div className="d-flex gap flex-column">
                  ...
                  <div className="d-flex align-items-center gap-3">
                    ...
                    <div style={{ width: "100%" }}>
                      <div className="d-flex justify-content-between  ">
                        <h6 className="mb-2">Outstanding</h6>
          ...
          <Card className="card-block card-stretch card-height">
            ...
            <Card.Body>
              ...
              <div className="d-flex align-items-top">
                ...
                <div className="profile-media ms-3 d-flex">
                  <div className="profile-dots-pills border-dark"></div>
                  <div className="ms-3">
                    <h6 className="mb-0">New user added in Qompac UI</h6>
                  </div>
                </div>
              </div>
              <div className="d-flex align-items-top">
