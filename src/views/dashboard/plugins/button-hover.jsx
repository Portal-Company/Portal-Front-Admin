          ...
          <Card>
            <Card.Body>
              <div className="d-flex flex-wrap align-items-center justify-content-between">
                ...
                <small>
                  For more Information regarding Button Hover Plugin refer
                  <Button
                    href="https://ianlunn.github.io/Hover/#effects"
                    target="_blank"
                    bsPrefix=""
                  >
                    Documentation
      ...
      <Row>
          ...
          <Card>
            <Card.Header>
              <Card.Header.Title>
                <h4>2D Transition</h4>
                <p>
                  In this method, selecting only one option from a lots of
                  options while only using up as much space as a single option
                  excepted.
                </p>
              </Card.Header.Title>
            </Card.Header>
            <Card.Body className="text-center">
              <div className="iq-plugins-btn">
                <Button href="#" className=" me-4  hvr-grow ">
                  hvr-grow
                </Button>
                <Button href="#" className="me-4 hvr-shrink ">
                  hvr-shrink
                </Button>
                <Button href="#" className="me-4 hvr-wobble-to-bottom-right">
                  hvr-wobble-to-bottom-right
                </Button>
                <Button href="#" className="me-4 hvr-pulse">
                  hvr-pulse
                </Button>
                <Button href="#" className="me-4 hvr-pulse-grow">
                  hvr-pulse-grow
                </Button>
                <Button href="#" className="me-4 hvr-push">
                  hvr-push
                </Button>
                <Button href="#" className="me-4 hvr-grow-rotate">
                  hvr-grow-rotate
                </Button>
                <Button href="#" className="me-4 hvr-pop">
                  hvr-pop
                </Button>
                <Button href="#" className="me-4 hvr-wobble-to-top-right">
                  hvr-wobble-to-top-right
                </Button>
                <Button href="#" className="me-4 hvr-bounce-in">
                  hvr-bounce-in
                </Button>
                <Button href="#" className="me-4 hvr-bounce-out">
                  hvr-bounce-out
                </Button>
                <Button href="#" className="me-4 hvr-rotate">
                  hvr-rotate
                </Button>
                <Button href="#" className="me-4 hvr-wobble-bottom">
                  hvr-wobble-bottom
                </Button>
                <Button href="#" className="me-4 hvr-wobble-vertical">
                  hvr-wobble-vertical
                </Button>
                <Button href="#" className="me-4 hvr-skew-forward">
                  hvr-skew-forward
                </Button>
                <Button href="#" className="me-4 hvr-skew-backward">
                  hvr-skew-backward
                </Button>
                <Button href="#" className="me-4 hvr-bob">
                  hvr-bob
                </Button>
                <Button href="#" className="me-4 hvr-hang">
                  hvr-hang
                </Button>
                <Button href="#" className="me-4 hvr-wobble-horizontal">
                  hvr-wobble-horizontal
                </Button>
                <Button href="#" className="me-4 hvr-skew">
                  hvr-skew
                </Button>
                <Button href="#" className="me-4 hvr-wobble-skew">
                  hvr-wobble-skew
                </Button>
                <Button href="#" className="me-4 hvr-buzz">
                  hvr-buzz
                </Button>
                <Button href="#" className="me-4 hvr-wobble-top">
                  hvr-wobble-top
                </Button>
                <Button href="#" className="me-4 hvr-float">
                  hvr-float
                </Button>
                <Button href="#" className="me-4 hvr-sink">
                  hvr-sink
                </Button>
                <Button href="#" className="me-4 hvr-buzz-out">
                  hvr-buzz-out
                </Button>
                <Button href="#" className="me-4 hvr-forward">
                  hvr-forward
                </Button>
                <Button href="#" className="me-4 hvr-backward">
                  hvr-backward
                </Button>
                <Button href="#" className="me-4 hvr-grow">
                  hvr-grow
        ...
        <Col lg="12">
          <Card>
            ...
            <Card.Body className="text-center">
              <div className="iq-plugins-btn">
                <Button href="#" className="me-4  hvr-fade">
                  Fade
                </Button>
                <Button href="#" className="me-4  hvr-sweep-to-right">
                  Sweep To Right
                </Button>
                <Button href="#" className="me-4  hvr-sweep-to-left">
                  Sweep To Left
                </Button>
                <Button href="#" className="me-4  hvr-sweep-to-bottom">
                  Sweep To Bottom
                </Button>
                <Button href="#" className="me-4  hvr-sweep-to-top">
                  Sweep To Top
                </Button>
                <Button href="#" className="me-4  hvr-bounce-to-right">
                  Bounce To Right
                </Button>
                <Button href="#" className="me-4  hvr-bounce-to-left">
                  Bounce To Left
                </Button>
                <Button href="#" className="me-4  hvr-bounce-to-bottom">
                  Bounce To Bottom
                </Button>
                <Button href="#" className="me-4  hvr-bounce-to-top">
                  Bounce To Top
                </Button>
                <Button href="#" className="me-4  hvr-rectangle-out">
                  Rectangle Out
                </Button>
                <Button href="#" className="me-4  hvr-radial-out">
                  Radial Out
                </Button>
                <Button href="#" className="me-4  hvr-shutter-out-horizontal">
                  Shutter Out Horizontal
                </Button>
                <Button href="#" className="me-4  hvr-shutter-out-vertical">
            ...
            <Card.Header>
              <Card.Header.Title>
                ...
                <small>
                  ...
                  <Link to="https://fortawesome.github.io/Font-Awesome/">
                    FontAwesome
                  </Link>
                  .{" "}
                  <Link to="https://github.com/IanLunn/Hover/#using-icon-effects">
                    How to use icons
                  </Link>{" "}
                  with Hover.css.
                </small>
            ...
            <Card.Body className=" text-center">
              <div className="iq-plugins-btn">
                <Button href="#" className="me-4  hvr-icon-back">
                  <svg
                    className="size-28 hvr-icon me-1"
                    viewBox="0 0 24 24"
                    fill="none"
                ...
                <Button href="#" className="me-4  hvr-icon-forward">
                  Icon Forward
                  <svg
                    className="size-28 hvr-icon ms-1"
                    viewBox="0 0 24 24"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
        ...
        <Col lg="12">
          <Card>
            ...
            <Card.Body className="text-center">
              <div className="iq-plugins-btn">
                <Button href="#" className="me-4  hvr-border-fade">
                  Border Fade
                </Button>
                <Button href="#" className="me-4 hvr-hollow">
                  Hollow
                </Button>
                <Button href="#" className="me-4 hvr-trim">
                  Trim
                </Button>
                <Button href="#" className="me-4 hvr-ripple-out">
                  Ripple Out
                </Button>
                <Button href="#" className="me-4 hvr-ripple-in">
                  Ripple In
                </Button>
                <Button href="#" className="me-4 hvr-outline-out">
                  Outline Out
                </Button>
                <Button href="#" className="me-4 hvr-outline-in">
                  Outline In
                </Button>
                <Button href="#" className="me-4 hvr-round-corners">
                  Round Corners
                </Button>
                <Button href="#" className="me-4 hvr-underline-from-left">
                  Underline From Left
                </Button>
                <Button href="#" className="me-4 hvr-underline-from-center">
                  Underline From Center
                </Button>
                <Button href="#" className="me-4 hvr-underline-from-right">
                  Underline From Right
                </Button>
                <Button href="#" className="me-4 hvr-reveal">
                  Reveal
                </Button>
                <Button href="#" className="me-4 hvr-underline-reveal">
                  Underline Reveal
                </Button>
                <Button href="#" className="me-4 hvr-overline-reveal">
                  Overline Reveal
                </Button>
                <Button href="#" className="me-4 hvr-overline-from-left">
                  Overline From Left
                </Button>
                <Button href="#" className="me-4 hvr-overline-from-center">
                  Overline From Center
                </Button>
                <Button href="#" className="me-4 hvr-overline-from-right">
                  Overline From Right
                </Button>
              </div>
            </Card.Body>
        ...
        <Col lg="12">
          <Card>
            ...
            <Card.Body className="text-center">
              <div className="iq-plugins-btn">
                <Button href="#" className="me-4 hvr-shadow ">
                  Shadow
                </Button>
                <Button href="#" className="me-4 hvr-grow-shadow">
                  Grow Shadow
                </Button>
                <Button href="#" className="me-4 hvr-float-shadow">
                  Float Shadow
                </Button>
                <Button href="#" className="me-4 hvr-glow ">
                  Glow
                </Button>
                <Button href="#" className="me-4 hvr-shadow-radial">
                  Shadow Radial
                </Button>
                <Button href="#" className="me-4 hvr-box-shadow-outset ">
                  Box Shadow Outset
                </Button>
                <Button href="#" className="me-4 hvr-box-shadow-inset ">
                  Box Shadow Inset
                </Button>
              </div>
            </Card.Body>
        ...
        <Col lg="12">
          <Card>
            ...
            <Card.Body className="text-center">
              <div className="iq-plugins-btn">
                <Button href="#" className="me-4 hvr-bubble-top">
                  Bubble Top
                </Button>
                <Button href="#" className="me-4 hvr-bubble-right">
                  Bubble Right
                </Button>
                <Button href="#" className="me-4 hvr-bubble-bottom">
                  Bubble Bottom
                </Button>
                <Button href="#" className="me-4 hvr-bubble-left">
                  Bubble Left
                </Button>
                <Button href="#" className="me-4 hvr-bubble-float-top">
                  Bubble Float Top
                </Button>
                <Button href="#" className="me-4 hvr-bubble-float-right">
                  Bubble Float Right
                </Button>
                <Button href="#" className="me-4 hvr-bubble-float-bottom">
                  Bubble Float Bottom
                </Button>
                <Button href="#" className="me-4 hvr-bubble-float-left">
                  Bubble Float Left
                </Button>
              </div>
            </Card.Body>
          ...
          <Card>
            ...
            <Card.Body className="text-center">
              <div className="iq-plugins-btn hrv-curl">
                <Button href="#" className="me-4 hvr-curl-top-left">
                  Curl Top Left
                </Button>
                <Button href="#" className="me-4 hvr-curl-top-right">
                  Curl Top Right
                </Button>
                <Button href="#" className="me-4 hvr-curl-bottom-right">
                  Curl Bottom Right
                </Button>
                <Button href="#" className="me-4 hvr-curl-bottom-left">
                  Curl Bottom Left
                </Button>
              </div>
            </Card.Body>
