                    ...
                    <Card.Body>
                        <div className="icon-grid">
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-1" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-2" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-3" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-4" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-5" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-6" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                                <div id="dual-svg-container-6">
                                    <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <mask id="mask4" maskUnits="userSpaceOnUse" x="6" y="11" width="12" height="10">
                                            <path fillRule="evenodd" clipRule="evenodd" d="M6.5 11.4788H17.3964V20.4182H6.5V11.4788Z" fill="white" />
                                        </mask>
                                        <g mask="url(#mask0)">
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-7" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-8" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-9" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-10" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-11" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                                <div id="dual-svg-container-11">
                                    <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <mask id="mask1" maskUnits="userSpaceOnUse" x="3" y="6" width="10" height="12">
                                            <path fillRule="evenodd" clipRule="evenodd" d="M12.5215 6.50024L12.5215 17.3966H3.58202L3.58202 6.50024L12.5215 6.50024Z" fill="white" />
                                        </mask>
                                        <g mask="url(#mask0)">
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-12" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-13" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-14" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-15" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-16" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                                <div id="dual-svg-container-16">
                                    <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <mask id="mask2" maskUnits="userSpaceOnUse" x="11" y="6" width="10" height="12">
                                            <path fillRule="evenodd" clipRule="evenodd" d="M11.4785 17.4998V6.60336H20.418V17.4998H11.4785Z" fill="white" />
                                        </mask>
                                        <g mask="url(#mask0)">
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-17" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-18" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-19" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-20" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-21" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                                <div id="dual-svg-container-21">
                                    <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <mask id="mask3" maskUnits="userSpaceOnUse" x="6" y="3" width="12" height="10">
                                            <path fillRule="evenodd" clipRule="evenodd" d="M17.5 12.5212L6.6036 12.5212L6.6036 3.58178L17.5 3.58178V12.5212Z" fill="white" />
                                        </mask>
                                        <g mask="url(#mask0)">
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-22" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-23" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-24" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-25" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-26" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-27" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-28" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-29" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                                <div id="dual-svg-container-29">
                                    <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fillRule="evenodd" clipRule="evenodd" d="M6.18493 14.2054C-0.246553 6.91826 2.96919 4.73963 3.25374 4.38547C6.32245 1.27315 6.79846 2.68979 9.20921 5.13672C11.2402 7.20803 8.60732 8.19539 9.68628 10.6531L6.18493 14.2054Z" fill="currentColor" />
                                        <path fillRule="evenodd" clipRule="evenodd" d="M12.09 13.3826C15.3702 16.0763 16.2953 12.2235 18.6188 14.5846C21.0158 17.0315 22.3941 17.5252 19.3547 20.6268C18.9973 20.938 16.6949 24.4689 8.79932 16.7417L12.09 13.3826Z" fill="currentColor" />
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-30" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-31" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-32" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-33" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-34" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-35" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-36" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-37" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-38" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-39" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-40" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-41" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-42" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-43" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-44" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-45" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-46" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-47" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-48" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-49" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-50" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-52" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-53" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-54" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-55" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-56" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-57" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-58" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-59" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-60" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-61" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-62" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                                <div id="dual-svg-container-62">
                                    <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.4" d="M22 11.9998C22 17.5238 17.523 21.9998 12 21.9998C6.477 21.9998 2 17.5238 2 11.9998C2 6.47776 6.477 1.99976 12 1.99976C17.523 1.99976 22 6.47776 22 11.9998Z" fill="currentColor" />
                                        <path fillRule="evenodd" clipRule="evenodd" d="M7.52075 10.8035C6.85975 10.8035 6.32275 11.3405 6.32275 11.9995C6.32275 12.6595 6.85975 13.1975 7.52075 13.1975C8.18175 13.1975 8.71875 12.6595 8.71875 11.9995C8.71875 11.3405 8.18175 10.8035 7.52075 10.8035ZM11.9999 10.8035C11.3389 10.8035 10.8019 11.3405 10.8019 11.9995C10.8019 12.6595 11.3389 13.1975 11.9999 13.1975C12.6609 13.1975 13.1979 12.6595 13.1979 11.9995C13.1979 11.3405 12.6609 10.8035 11.9999 10.8035ZM15.2813 11.9995C15.2813 11.3405 15.8183 10.8035 16.4793 10.8035C17.1403 10.8035 17.6773 11.3405 17.6773 11.9995C17.6773 12.6595 17.1403 13.1975 16.4793 13.1975C15.8183 13.1975 15.2813 12.6595 15.2813 11.9995Z" fill="currentColor" />
                                    </svg>
                                </div>
                            </div>
                            <div className="icon-box">
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-64" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-65" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-66" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-67" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-68" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-69" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-70" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-71" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-72" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-73" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-74" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-75" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-76" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-77" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-78" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-79" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-80" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-81" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-82" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-83" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-84" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-85" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-86" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-87" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-88" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-89" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-90" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-91" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-92" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-93" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-94" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-97" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-98" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-99" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                            ...
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-100" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                                <div id="dual-svg-container-100">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" viewBox="0 0 24 24" fill="none">
                                        <circle cx="12" cy="12" r="7.5" fill="currentColor" fillOpacity="0.4" stroke="currentColor" />
                                    </svg>
                                </div>
                            </div>
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-101" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                                <div id="dual-svg-container-101">
                                    <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path id="Ellipse 158" d="M22.4541 11.3918C22.7819 11.7385 22.7819 12.2615 22.4541 12.6082C21.0124 14.1335 16.8768 18 12 18C7.12317 18 2.98759 14.1335 1.54586 12.6082C1.21811 12.2615 1.21811 11.7385 1.54586 11.3918C2.98759 9.86647 7.12317 6 12 6C16.8768 6 21.0124 9.86647 22.4541 11.3918Z" fill="#130F26" fillOpacity="0.4" stroke="#130F26" />
                                        ...
                                        <circle id="Ellipse 161" opacity="0.53" cx="13.5" cy="10.5" r="1.5" fill="white" />
                                    </svg>
                                </div>
                            </div>
                            <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top" delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#dual-svg-container-102" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                </div>
                                <div id="dual-svg-container-102">
                                    <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path d="M4 3.00004C4 1.89547 4.89543 1.00004 6 1.00004H13.0801C13.664 1.00004 14.2187 1.25517 14.5986 1.69845L19.5185 7.43826C19.8292 7.80075 20 8.26243 20 8.73985V21C20 22.1046 19.1046 23 18 23H6C4.89543 23 4 22.1046 4 21V3.00004Z" fill="#130F26" fillOpacity="0.4" />
