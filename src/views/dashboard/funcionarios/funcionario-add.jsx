    ...
    onSubmit: async (data) => {
      try {
        ...
        const contactResponse = await (
          await api.post("/contact/post", contact)
        ).data;
          ...
          <Card.Body>
            <Form onSubmit={formik.handleSubmit} encType="multipart/form-data">
              <Row>
                <Col md="6" className="mb-3">
                  ...
                  <Form.Group className="mb-3 form-group mt-2">
                    ...
                    >
                      ...
                      {userData?.Escola?.Organigrama?.Departamento?.map(
                        (item) => (
                ...
                <Col md="6" className="mb-3">
                  <Form.Group className="mb-3 form-group mt-2">
                    <Form.Label htmlFor="validationDefault04">Cargo</Form.Label>
                    <Form.Select
                      id="cargoId"
                      name="cargoId"
                      required
                  ...
                  <Form.Group className="mb-3 form-group mt-2">
                    ...
                    <Form.Control
                      ...
                      id="numero_agente"
                      name="numero_agente"
                      value={formik.values.numero_agente}
                      onChange={formik.handleChange}
                      required
                    />
                    {formik?.touched?.numero_agente &&
